...
class App(ctk.CTk):
    ...
    def _build_sidebar(self):
        title = ctk.CTkLabel(
            ...
            font=ctk.CTkFont(family="DejaVu Sans", size=18, weight="bold"),
            text_color="#ffffff"
        )
    ...
    def _build_content(self):
        ...
        result_header = ctk.CTkLabel(
            ...
            font=ctk.CTkFont(family="DejaVu Sans", size=16, weight="bold"),
            text_color="#ffffff"
        )
        ...
        self.result_box = ctk.CTkTextbox(
            self.content_area,
            font=ctk.CTkFont(family="DejaVu Sans", size=13),
            corner_radius=12,
            fg_color="#0a1020",
            text_color="#d0d8e8",
            border_color="#2a3a5a",
...
if __name__ == "__main__":
    try:
        logger.info(f"Starting G-Vision OCR v{__version__} (Linux)")
        app = App()
        app.mainloop()
